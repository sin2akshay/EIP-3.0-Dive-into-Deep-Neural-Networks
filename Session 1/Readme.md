...
What is also important here is to remember that we need to maintain a separate channel for any feature. 

A kernel or feature extractor or filter extracts features and then these features are stored in a channel or a feature map (which we will call image as well).
...
So we need to move from 400x400 to 10x10 or cover 390x390 in receptive field. 

This is how things would progress each time we add a 3x3 convolution layer
...
What all can you tell about the image? A man, a woman, a child, a house, green walkway. House probably have a chimney. Sun and cloud, etc. We can say all of this about this image because these are the feature which is the "loudest". Look at the original image below:
...
4002	3982	3962	3942	3922	3902	MaxP	1952	1932	1912
1892	1872	1852	1832	1812	MaxP	902	882	862	842
822	802	MaxP	402	382	362	342	322	MaxP	162
142	122	102							
...
bit.ly/2IBqQJD (Links to an external site.)Links to an external site.
